    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className="hidden lg:flex w-64 flex-col fixed inset-y-0 bg-amber-900 text-amber-50 shadow-2xl">
        ...
        <nav className="flex-1 px-4 py-4 space-y-2">
          <Button
            variant="ghost"
            className="w-full justify-start gap-3 hover:bg-amber-800 text-amber-100"
            onClick={() => router.push("/staff")}
          >
            <Map className="w-5 h-5" /> Table Map
          </Button>
          <Button
            variant="ghost"
            className="w-full justify-start gap-3 hover:bg-amber-800 text-amber-100"
          ...
          >
            <ListOrdered className="w-5 h-5" /> Order List
          </Button>
          <Button
            variant="ghost"
            className="w-full justify-start gap-3 hover:bg-amber-800 text-amber-100"
        ...
        <div className="p-4 border-t border-amber-800">
          ...
          <Button
            variant="outline"
            className="w-full border-amber-700 hover:bg-amber-800 text-amber-100 gap-2"
            onClick={() => logout()}
          >
