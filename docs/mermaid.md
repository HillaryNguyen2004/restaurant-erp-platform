...
subgraph BM["Billing and Receipt Management module"]
direction TB
    ...
    subgraph BM_BUS["Business Layer"]
        ...
        BMB3["Receipt and Reporting Service"]
    end
...
direction TB
    ...
    subgraph IM_BUS["Business Layer"]
        ...
        IMB4["Waste and Spoilage Service"]
    ...
    subgraph IM_PER["Persistence Layer"]
        ...
        IMP3["Waste and Spoilage Log Repository"]
...
subgraph AR["Analytics and Reports module"]
direction TB
...
direction TB
    ...
    subgraph AT_BUS["Business Layer"]
        ...
        ATB2["Audit and Security Service"]
    end
...
DO -. "authentication and authorization" .-> UM
KO -. "authentication and authorization" .-> UM
TR -. "authentication and authorization" .-> UM
BM -. "authentication and authorization" .-> UM
IM -. "authentication and authorization" .-> UM
AR -. "authentication and authorization" .-> UM
AT -. "authentication and authorization" .-> UM
...
ECB -. "table or reservation updates" .-> DO
...
DO -. "sales and order data" .-> ECB
KO -. "kitchen performance data" .-> ECB
BM -. "revenue and transaction data" .-> ECB
IM -. "stock and waste data" .-> ECB
